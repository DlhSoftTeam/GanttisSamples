...
class ViewController: NSViewController {
    ...
    static let clearColor = Ganttis.Color(red: 0.5, green: 0.5, blue: 0.5, alpha: 0)
...
class CustomGanttChartContentPresenter: GanttChartContentPresenter {
    ...
    func drawBackground(color: Ganttis.Color, size: Size) {
        ganttChartContent.drawBackground(color: color, size: size)
    }
    func drawBorder(in rectangle: Ganttis.Rectangle, line: Line, lineWidth: Double, color: Ganttis.Color) {
        ganttChartContent.drawBorder(in: rectangle, line: line, lineWidth: lineWidth, color: color)
    }
    func drawBackground(for row: Row, in rectangle: Ganttis.Rectangle, color: Ganttis.Color) {
        ganttChartContent.drawBackground(for: row, in: rectangle, color: color)
    }
    func drawBorder(for row: Row, in rectangle: Ganttis.Rectangle, line: Line, lineWidth: Double, color: Ganttis.Color) {
        ganttChartContent.drawBorder(for: row, in: rectangle, line: line, lineWidth: lineWidth, color: color)
    }
    func drawRegionalBackground(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, color: Ganttis.Color) {
    ...
    func drawBar(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, fillColor: Ganttis.Color, secondaryFillColor: Ganttis.Color, strokeColor: Ganttis.Color?, strokeWidth: Double, cornerRadius: Double, isHighlighted: Bool, isFocused: Bool, isSelected: Bool, highlightColor: Ganttis.Color, focusColor: Ganttis.Color, selectionColor: Ganttis.Color, highlightWidth: Double, focusWidth: Double, selectionWidth: Double, allowsMoving: Bool, allowsResizing: Bool, allowsResizingAtStart: Bool, allowsMovingVertically: Bool, thumbDistance: Double) {
    ...
    func drawSummaryBar(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, fillColor: Ganttis.Color, secondaryFillColor: Ganttis.Color, strokeColor: Ganttis.Color?, strokeWidth: Double, triangleInset: Double, triangleScale: Double, isExpanded: Bool, isHighlighted: Bool, isFocused: Bool, isSelected: Bool, highlightColor: Ganttis.Color, focusColor: Ganttis.Color, selectionColor: Ganttis.Color, highlightWidth: Double, focusWidth: Double, selectionWidth: Double, allowsMoving: Bool, allowsResizing: Bool, allowsResizingAtStart: Bool, allowsMovingVertically: Bool, thumbDistance: Double) {
    ...
    func drawMilestone(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, fillColor: Ganttis.Color, secondaryFillColor: Ganttis.Color, strokeColor: Ganttis.Color?, strokeWidth: Double, isHighlighted: Bool, isFocused: Bool, isSelected: Bool, highlightColor: Ganttis.Color, focusColor: Ganttis.Color, selectionColor: Ganttis.Color, highlightWidth: Double, focusWidth: Double, selectionWidth: Double, allowsMoving: Bool, allowsMovingVertically: Bool, thumbDistance: Double) {
    ...
    func drawCompletionBar(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, fillColor: Ganttis.Color, secondaryFillColor: Ganttis.Color, strokeColor: Ganttis.Color?, strokeWidth: Double, cornerRadius: Double, allowsResizing: Bool, thumbDistance: Double) {
    ...
    func drawBarLabel(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, text: String, foregroundColor: Ganttis.Color, alignment: Ganttis.TextAlignment, font: Ganttis.Font) {
    ...
    func drawAttachmentLabel(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, text: String, foregroundColor: Ganttis.Color, font: Ganttis.Font) {
    ...
    func drawDependencyLine(for dependency: GanttChartDependency, as polyline: Polyline, color: Ganttis.Color, width: Double, arrowWidth: Double, arrowLength: Double, isHighlighted: Bool, isFocused: Bool, isSelected: Bool, highlightWidth: Double, focusWidth: Double, selectionWidth: Double) {
    ...
    func drawDependencyLineThumb(for item: GanttChartItem, type: GanttChartDependencyEndType, center: Point, radius: Double, color: Ganttis.Color) {
        ganttChartContent.drawDependencyLineThumb(for: item, type: type, center: center, radius: radius, color: color)
    }
    func drawTemporaryDependencyLine(from: GanttChartItem, to: GanttChartItem?, type: GanttChartDependencyType, as polyline: Polyline, color: Ganttis.Color, width: Double, arrowWidth: Double, arrowLength: Double, dashWidth: Double) {
    ...
    func drawTemporaryBar(in rectangle: Ganttis.Rectangle, color: Ganttis.Color, cornerRadius: Double, dashWidth: Double) {
        ganttChartContent.drawTemporaryBar(in: rectangle, color: color, cornerRadius: cornerRadius, dashWidth: dashWidth)
    }
    func drawTimeArea(for highlighter: ScheduleTimeSelector, in rectangle: Ganttis.Rectangle, fillColor: Ganttis.Color) {
        ganttChartContent.drawTimeArea(for: highlighter, in: rectangle, fillColor: fillColor)
    }
    func drawTimeArea(for highlighter: TimeSelector, in rectangle: Ganttis.Rectangle, backgroundColor: Ganttis.Color) {
        ganttChartContent.drawTimeArea(for: highlighter, in: rectangle, backgroundColor: backgroundColor)
    }
    func drawTimeAreaBorder(for highlighter: TimeSelector, in rectangle: Ganttis.Rectangle, line: Line, lineWidth: Double, color: Ganttis.Color) {
        ganttChartContent.drawTimeAreaBorder(for: highlighter, in: rectangle, line: line, lineWidth: lineWidth, color: color)
    }
    func drawTimeAreaLabel(for highlighter: TimeSelector, in rectangle: Ganttis.Rectangle, text: String, foregroundColor: Ganttis.Color, alignment: Ganttis.TextAlignment, font: Ganttis.Font, verticalAlignment: VerticalTextAlignment) {
    ...
    private func drawCustomHeightBar(for item: GanttChartItem, in rectangle: Ganttis.Rectangle, fillColor: Ganttis.Color, secondaryFillColor: Ganttis.Color, strokeColor: Ganttis.Color?, strokeWidth: Double, cornerRadius: Double, isHighlighted: Bool, isFocused: Bool, isSelected: Bool, highlightColor: Ganttis.Color, focusColor: Ganttis.Color, selectionColor: Ganttis.Color, highlightWidth: Double, focusWidth: Double, selectionWidth: Double, allowsMoving: Bool, allowsResizing: Bool, allowsResizingAtStart: Bool, allowsMovingVertically: Bool, thumbDistance: Double) {
